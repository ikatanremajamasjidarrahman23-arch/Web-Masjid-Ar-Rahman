    ...
    <div className="bg-gray-50 min-h-screen py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="text-center animate-fade-in flex flex-col items-center">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight">Jadwal Kajian Rutin</h1>
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            Mari bersama-sama memperdalam ilmu agama di taman-taman syurga. Kajian terbuka untuk umum.
          </p>
        </div>
        ...
        <div className="animate-fade-in" style={{ animationDelay: "0.2s" }}>
          {schedules.length === 0 ? (
            <div className="bg-white p-10 text-center rounded-2xl border border-gray-100 shadow-sm">
              <p className="text-gray-500 text-lg">Jadwal kajian belum tersedia saat ini.</p>
            </div>
          ) : (
